...
#define TAPPING_TERM_PER_KEY
  ...
  #define PS2_CLOCK_BIT 1  // data pin 1
  #define PS2_INT_INIT() do { EICRA |= ((1<<ISC11) | (0<<ISC10)); } while (0)
  ...
  #define PS2_DATA_BIT 0 // data pin 2
...
#define MH_AUTO_BUTTONS_TIMEOUT 300
  ...
  #define RGB_MATRIX_REST_MODE RGB_MATRIX_TYPING_HEATMAP
...
# if defined CUSTOM_SPLIT_TRANSPORT_SYNC
